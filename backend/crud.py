...
def register_patient(patient):
    ...
    conn.execute("""
        INSERT INTO patients (
            ...
            bp_high, diabetic, sugar_level, bp_reading,
            allergies, existing_conditions, other_conditions,
            current_medications, family_history,
            sleep_quality, overthinking_level,
            anger_level, appetite_level,
            food_preferences, stress_level,
            energy_level
        )
        VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
